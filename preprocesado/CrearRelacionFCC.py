...
factura_cabecera = pd.read_csv("../files/originales/factura_cabecera_julio-2018.csv", sep=',', error_bad_lines=False, index_col=False, dtype='unicode', encoding="latin_1");
...
dt.to_csv("../files/procesados/fCabecera.csv",index = False);
